...
void Lvgl_main_page_set_style(Lvgl* const me)
{
    ...
    lv_obj_align(me->temp, LV_ALIGN_BOTTOM_LEFT,10,-40);
    //lv_obj_align(me->RH, LV_ALIGN_BOTTOM_MID,-120 ,-40);
...
void Lvgl_create_main_page(Lvgl * const me) {
    ...
    /*temp & RH*/
    me->temp = lv_label_create(me->screen);
   // me->RH = lv_label_create(me->screen);
...
void Lvgl_create_setting_page(Lvgl * const me, lvgl_setting_page_data_t* data) {
    ...
    time_h.roller_active_id = data->clock_hour;// why
